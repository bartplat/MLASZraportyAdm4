...
if (szk$S3_12[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    "% absolwentów Państwa szkoły pracowało^[Na podstawie umowy o pracę, umowy zlecenia lub prowadząc własną działalność gospodarczą.], ale nie uczęszczało do kolejnej szkoły. Do grupy pracujących, ale nie kontynuujących edukacji formalnej należało ",
    ...
    "% absolwentów Państwa branżowej szkoły I stopnia oraz ",
...
## Kontynuowanie nauki w branżowych szkołach II stopnia w podziale na wyuczony zawód
...
if (round(szk$E2_nauka_kontyn[[1]]$bs2 * szk$E2_nauka_kontyn[[1]]$n) >= progLiczebnosci) {
  ...
  if (length(szk$branze_zawody[[1]]) > 1 & l_col > 0) {
    cat(
      "W poniższej tabeli przedstawione zostały informacje o branżach, w których w branżowych szkołach II stopnia uczyli się absolwenci Państwa szkoły, należący do poszczególnych grup (liczących co najmniej 10 osób) wyróżnionych ze względu na zawód, w którym się kształcili.")
...
if (szk$Z4_ucz[[1]]$n >= progLiczebnosci) {
  ...
  if (length(przeprac_ods$name[przeprac_ods$value == max(przeprac_ods$value)]) == 1) {
    cat(
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wykres = wykres_pion_skum(tab_wyk, wyk_tyt) +
    scale_fill_manual(values = c("#90cf60",
                                 "#d8ef8a",
                                 "#f8dd00",
                                 "#fb8c59")) +
    ylab("Odsetek absolwentów")
...
if (szk$Z9_mlod_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wykres = wykres_poziomy_statusy(tab_wyk, wyk_tyt) +
    scale_fill_manual(values = c("#d62f26",
                                 "#fb8c59"))
...
if (szk$Z9_mlod_nie_ucz[[1]]$n >= progLiczebnosci) {
  ...
  if (length(god$Z9_mlod_nie_ucz[[1]]) > 1) {
  ...
  if (god$Z9_mlod_nie_ucz[[1]]$n %in% 0) {
    cat("Wyniki dla grupy odniesienia nie zostały przedstawione ze względu na zbyt małą liczbę absolwentów (mniej niż 10) lub szkół (mniej niż 3)")
  }
} else {
  cat(
...
# 6. Aneks: wyniki dla absolwentów branżowych szkół I stopnia `r ifelse(woj$l_abs[[1]] < progLiczebnosci, paste0(""), paste0("z województwa i", "\u00A0"))`z`r paste0("\u00A0")`całego kraju
...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli branżowe szkoły I stopnia (BS I) `r ifelse(woj$l_abs[[1]] < progLiczebnosci, paste0(""), paste0("w województwie, w którym znajduje się Państwa szkoła oraz "))`w całym kraju.
...
if (woj$l_abs[[1]] < progLiczebnosci | woj$Z4_ucz[[1]]$n < progLiczebnosci) {
  cat("Procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów branżowych szkół I stopnia z całego kraju.\n\n",
  ...
  tabelka = tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci BS I z całego\nkraju kontynuujący naukę" = 1, "Absolwenci BS I z całego\nkraju niekontynuujący nauki" = 1), align = c("l", "c", "c"))
...
if (woj$l_abs[[1]] >= progLiczebnosci & woj$Z4_ucz[[1]]$n >= progLiczebnosci) {
  cat("  a) województwo ",
      woj$odmiany[[1]]$nazwa,
      "\n\n* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów branżowych szkół I stopnia z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      "\n\n",
      sep = "")
  ...
  tabelka = tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci BS I\nkontynuujący naukę" = 1, "Absolwenci BS I\nniekontynuujący nauki" = 1),
                     align = c("l", "c", "c"))
  ...
  cat("\n\n* Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów branżowych szkół I stopnia z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      "\n\n",
      sep = "")
  ...
  cat("\n\n  b) cały kraj\n\n* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów branżowych szkół I stopnia z całego kraju.\n\n")
...
if (woj$l_abs[[1]] < progLiczebnosci | sum(woj$B2_bezrob[[1]]$n) < progLiczebnosci) {
  cat("Procentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów branżowych szkół I stopnia z całego kraju.")
  ...
  cat("  a) województwo ",
      woj$odmiany[[1]]$nazwa,
      "\n\nProcentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów branżowych szkół I stopnia z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      ".\n\n",
      sep = "")
