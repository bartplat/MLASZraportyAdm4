...
if (szk$S3_12[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    "% absolwentów Państwa liceum pracowało^[Na podstawie umowy o pracę, umowy zlecenia lub prowadząc własną działalność gospodarczą.], ale nie kontynuowało nauki. Do grupy pracujących, ale nie kontynuujących edukacji formalnej należało ",
...
if (any(!is.na(szk$liczebnosc_dziedziny[[1]]$odsetek))) {
  if (round(szk$E2_nauka_kontyn[[1]]$studia * szk$E2_nauka_kontyn[[1]]$n) >= progLiczebnosci) {
    ...
    } else if (sum(szk$liczebnosc_dziedziny[[1]]$odsetek > 0, na.rm = TRUE) > 1 & sum(szk$liczebnosc_dziedziny[[1]]$odsetek %in% max(szk$liczebnosc_dziedziny[[1]]$odsetek)) %in% 1) {
      cat(
...
if (round(szk$E2_nauka_kontyn[[1]]$studia * szk$E2_nauka_kontyn[[1]]$n) >= progLiczebnosci) {
  if (any(!is.na(szk$liczebnosc_dyscypliny[[1]]$odsetek))) {
    ...
    } else if (sum(szk$liczebnosc_dyscypliny[[1]]$odsetek > 0, na.rm = TRUE) > 1 & sum(szk$liczebnosc_dyscypliny[[1]]$odsetek %in% max(szk$liczebnosc_dyscypliny[[1]]$odsetek)) %in% 1) {
      cat(
...
## Kontynuowanie nauki na studiach w poszczególnych dyscyplinach w podziale na płeć

```{r}
if (round(szk$E2_nauka_kontyn[[1]]$studia * szk$E2_nauka_kontyn[[1]]$n) >= progLiczebnosci) {
  if (any(!is.na(szk$dyscypliny_kob[[1]]$odsetek))) {
    cat(
      "Poniższa tabela prezentuje rozkład dyscyplin, w których kontynuowały naukę absolwentki Państwa szkoły.\n\nTabela ",
      tab_num(),
      ": Dyscypliny, w których absolwentki Państwa szkoły najczęściej studiowały w grudniu ",
      params$rok,
...
```{r}
if (round(szk$E2_nauka_kontyn[[1]]$studia * szk$E2_nauka_kontyn[[1]]$n) >= progLiczebnosci) {
  if (any(!is.na(szk$dyscypliny_mez[[1]]$odsetek))) {
    cat(
      "Poniższa tabela prezentuje rozkład dyscyplin, w których kontynuowali naukę absolwenci Państwa szkoły.\n\nTabela ",
      tab_num(),
      ": Dyscypliny, w których absolwenci Państwa szkoły najczęściej studiowali w grudniu ",
      params$rok,
...
# 6. Aneks: wyniki dla absolwentów liceów ogólnokształcących dla młodzieży `r ifelse(woj$l_abs[[1]] < progLiczebnosci, paste0(""), paste0("z województwa i", "\u00A0"))`z`r paste0("\u00A0")`całego kraju
...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli licea ogólnokształcące dla młodzieży `r ifelse(woj$l_abs[[1]] < progLiczebnosci, paste0(""), paste0("w województwie, w którym znajduje się Państwa szkoła oraz "))`w całym kraju.
...
if (woj$l_abs[[1]] < progLiczebnosci | woj$S3_12[[1]]$n < progLiczebnosci) {
  god2$S3_12[[1]] %>%
    ...
    mutate(across(n, ~linebreak(paste0("Absolwenci liceów\nogólnokształcących\ndla młodzieży\nw całym kraju"), align = "l"))) %>%
    mutate(across(tylko_ucz:neet,
                  ~paste0(round(. * 100), "\\%"))) %>%
    kable(format = "latex", booktabs = TRUE, escape = FALSE, longtable = TRUE,
          linesep = "",
...
if (woj$l_abs[[1]] < progLiczebnosci | woj$E2_nauka_kontyn[[1]]$n < progLiczebnosci) {
  ...
  tabelka = rbind(
    ...
    god2$E2_nauka_kontyn[[1]][-1] %>% 
      ...
      pivot_longer(everything()) %>% 
      filter(name %in% "brak")) %>% 
    # tu nie mogą kontynuować absolwenci LO
    filter(!name %in% c("lodd", "bs2"))
  
  tabelka$name = factor(tabelka$name,
                        levels = c("studia",
                                   "spolic",
                                   "kkz",
                                   # "lodd", # tu nie mogą kontynuować absolwenci LO
                                   # "bs2", # tu nie mogą kontynuować absolwenci LO
                                   "kuz",
                                   "brak"),
                        labels = c("Studia",
                                   "Szkoła policealna",
...
if (woj$l_abs[[1]] < progLiczebnosci | woj$Z4_ucz[[1]]$n < progLiczebnosci) {
  cat("Procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów liceów ogólnokształcących dla młodzieży z całego kraju.\n\n",
  ...
  cat("  b) Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku\n\n",
      "Procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów liceów ogólnokształcących dla młodzieży z całego kraju.\n\n")
  ...
  tabelka = tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci liceów ogólnokształcących\nz całego kraju kontynuujący naukę" = 1, "Absolwenci liceów ogólnokształcących\nz całego kraju niekontynuujący nauki" = 1), align = c("l", "c", "c"))
...
if (woj$l_abs[[1]] >= progLiczebnosci & woj$Z4_ucz[[1]]$n >= progLiczebnosci) {
  cat("  a) województwo ",
      woj$odmiany[[1]]$nazwa,
      "\n\n* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów liceów ogólnokształcących dla młodzieży z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      "\n\n",
      sep = "")
  ...
  tabelka = tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci liceów ogólnokształcących\nz województwa kontynuujący naukę" = 1, "Absolwenci liceów ogólnokształcących\nz województwa niekontynuujący nauki" = 1),
                     align = c("l", "c", "c"))
  ...
  cat("\n\n* Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów liceów ogólnokształcących dla młodzieży z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      "\n\n",
      sep = "")
  ...
  cat("\n\n  b) cały kraj\n\n* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów liceów ogólnokształcących dla młodzieży z całego kraju.\n\n")
  ...
  cat("\n\n* Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów liceów ogólnokształcących dla młodzieży z całego kraju.\n\n",
      sep = "")
...
if (woj$l_abs[[1]] < progLiczebnosci | sum(woj$B2_bezrob[[1]]$n) < progLiczebnosci) {
  cat("Procentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów liceów ogólnokształcących dla młodzieży z całego kraju.")
  ...
  cat("  a) województwo ",
      woj$odmiany[[1]]$nazwa,
      "\n\nProcentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów liceów ogólnokształcących dla młodzieży z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      ".\n\n",
      sep = "")
