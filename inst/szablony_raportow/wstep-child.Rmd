...
cat("\n\n## Idea monitoringu\n\n",
    ...
    "Należy pamiętać, że oprócz kształcenia w szkole, na sytuację edukacyjną i zawodową absolwentów wpływa wiele innych uwarunkowań, jak m.in. sytuacja na lokalnym rynku pracy, oferta edukacyjna i jej dostępność, jak również uwarunkowania rodzinne i osobiste. Ponadto dane, na podstawie których są sporządzane raporty, nie odzwierciedlają w pełni aktywności absolwentów, nie uwzględniają na przykład pracy za granicą ani dalszej edukacji za granicą. Nie obejmują również pracy podejmowanej na umowy o dzieło lub na zlecenie, ani pracy w szarej strefie. Dlatego informacji o losach absolwentów nie można, bez uwzględnienia dodatkowego kontekstu, traktować jako miary efektywności poszczególnych szkół.",
    sep = "")
```
...
cat("\n\n## Źródła i przetwarzanie danych\n\n",
    ...
    "Dane te przekazywane są do Centrum Informatycznego Edukacji, gdzie są przetwarzane, łączone i anonimizowane, a następnie przekazywane do Instytutu Badań Edukacyjnych. Eksperci Instytutu opracowują wyniki monitoringu karier absolwentów, w szczególności w formie raportu krajowego, raportów wojewódzkich i branżowych oraz raportów dla szkół, takich jak ten, który mają Państwo przed sobą.",
    sep = "")
```
...
cat("\n\n## Sposób prezentowania wyników\n\n",
    ...
    "W monitoringu, każdemu z absolwentów przypisany zostaje status, określający jego sytuację edukacyjną zawodową. W tegorocznej edycji raportów szkolnych, absolwentowi mógł zostać przypisany jeden z następujących statusów:\n\n",
    "* Nauka\n\n",
    "* Praca\n\n",
    "* Nauka i praca\n\n",
    "* Bezrobocie\n\n",
    "* Brak danych o aktywności\n\n",
    "Przypisanie absolwentowi określonego statusu w danym miesiącu oznacza, że przynajmniej przez jeden dzień w tym miesiącu miał taki status.\n\n",
...
cat("\n\n## Wykorzystanie raportu\n\n",
    ...
    "*Raport roczny z monitoringu karier absolwentów, których szkołą ukończoną w ", params$rok + 1, " roku była ", szk$dane_szkoly[[1]]$nazwa, ". Monitoring na podstawie danych rejestrowych. Warszawa: Instytut Badań Edukacyjnych, ",
    params$rok,
    ".*\n\n",
