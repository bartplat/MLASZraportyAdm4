...
cat("\n\n## Źródła i przetwarzanie danych\n\n",
    ...
    "Dzięki wykorzystaniu danych rejestrowych monitoring obejmuje niemal całą populację absolwentów^[Z monitoringu karier zgodnie z ustawą *Prawo oświatowe* wyłączeni są absolwenci szkół przy zakładach karnych i aresztach śledczych. Warunkiem uwzględnienia absolwenta w monitoringu jest odnotowanie przez szkołę w SIO faktu zakończenia nauki przez daną osobę.].\n\n",
...
cat("\n\n## Sposób prezentowania wyników\n\n",
    ...
    "Przypisanie absolwentowi określonego statusu w danym miesiącu oznacza, że przynajmniej przez jeden dzień w tym miesiącu miał taki status. W przypadku łączenia w tym samym miesiącu nauki lub pracy z bezrobociem absolwentami przypisywany jest status „nauka” lub „praca”.\n\n",
